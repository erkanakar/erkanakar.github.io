...
const menu=document.querySelector(".menu"),menuModal=document.querySelector(".menu-modal"),menuModalClose=document.querySelector(".close");var x,i,j,l,ll,selElmnt,a,b,c;for(menu.addEventListener("click",()=>{menuModal.classList.toggle("active"),$(".has-child").each(function(e,t){$(this).addClass("cssanimation sequence fadeInBottom")})}),menuModalClose.addEventListener("click",()=>{menuModal.classList.toggle("active"),$(".has-child").each(function(e,t){$(this).removeClass("cssanimation sequence fadeInBottom")})}),l=(x=document.getElementsByClassName("custom-select")).length,i=0;i<l;i++){for(ll=(selElmnt=x[i].getElementsByTagName("select")[0]).length,(a=document.createElement("DIV")).setAttribute("class","select-selected"),a.innerHTML=selElmnt.options[selElmnt.selectedIndex].innerHTML,x[i].appendChild(a),(b=document.createElement("DIV")).setAttribute("class","select-items select-hide"),j=1;j<ll;j++)(c=document.createElement("DIV")).innerHTML=selElmnt.options[j].innerHTML,c.addEventListener("click",function(e){for(var t,o,n,s=this.parentNode.parentNode.getElementsByTagName("select")[0],l=s.length,i=this.parentNode.previousSibling,c=0;c<l;c++)if(s.options[c].innerHTML==this.innerHTML){for(s.selectedIndex=c,i.innerHTML=this.innerHTML,n=(t=this.parentNode.getElementsByClassName("same-as-selected")).length,o=0;o<n;o++)t[o].removeAttribute("class");this.setAttribute("class","same-as-selected");break}i.click()}),b.appendChild(c);x[i].appendChild(b),a.addEventListener("click",function(e){e.stopPropagation(),closeAllSelect(this),this.nextSibling.classList.toggle("select-hide"),this.classList.toggle("select-arrow-active")})}function closeAllSelect(e){for(var t=[],o=document.getElementsByClassName("select-items"),n=document.getElementsByClassName("select-selected"),s=o.length,l=n.length,i=0;i<l;i++)e==n[i]?t.push(i):n[i].classList.remove("select-arrow-active");for(i=0;i<s;i++)t.indexOf(i)&&o[i].classList.add("select-hide")}document.addEventListener("click",closeAllSelect),window.onload=function(){var e=document.getElementById("hero-image");e&&(e.style.transform="scale(1)")},window.onscroll=function(){var e,t=document.getElementById("hero-image");t&&(e=window.scrollY,t.style.transform=0!=e?"scale(2.27)":"scale(1)",50<=e?(document.querySelector(".home-page-main-img-box a").style.opacity=0,document.querySelector("#breadcrumb").style.opacity=1):0==e&&(document.querySelector(".home-page-main-img-box a").style.opacity=1,document.querySelector("#breadcrumb").style.opacity=0),t=e-1e3,textSlide.style.transform="translate3d("+t+"px, 0, 0)")};const aboutUs=document.querySelector(".home-page-about-us"),testimonial=document.querySelector(".testimonial"),aboutUsMore=document.querySelector(".home-page-about-us-more"),teamSection=document.querySelector(".home-page-team-section"),textSlide=document.querySelector(".text-slide .text-slide-wrapper"),newSection=document.querySelector(".home-page-news");var breadcrumbDiv=document.querySelector("#breadcrumb"),sections=document.querySelectorAll("section");window.addEventListener("scroll",function(){sections.forEach(function(e){isInViewport(e,60)&&e.querySelector("h2")&&(e=e.querySelector("h2").textContent,breadcrumbDiv.innerHTML="<p>"+e+"</p>")})}),window.addEventListener("scroll",()=>{aboutUs&&isInViewport(aboutUs,75)&&aboutUs.classList.add("home-page-about-us-animate"),testimonial&&isInViewport(testimonial,60)&&testimonial.classList.add("testimonial-animate"),teamSection&&isInViewport(teamSection,60)&&teamSection.classList.add("team-section-animate"),newSection&&isInViewport(newSection,60)&&newSection.classList.add("home-page-news-animate"),aboutUsMore&&isInViewport(aboutUsMore,50)&&aboutUsMore.classList.add("home-page-about-us-more-animate")});const isInViewport=function(e,t){var e=e.getBoundingClientRect(),o=window.innerHeight||document.documentElement.clientHeight;return!(Math.floor(100-(0<=e.top?0:e.top)/-e.height*100)<t||Math.floor(100-(e.bottom-o)/e.height*100)<t)};function scrollDown(){$("html, body").animate({scrollTop:$(window).height()},"slow")}$(".question").click(function(){$(this).next(".answer").slideToggle(),$(this).toggleClass("question-opened")}),$(".scroll-down").click(scrollDown);const showMoreButton=document.querySelector(".show-more");showMoreButton.addEventListener("click",function(){for(const e of document.querySelectorAll(".home-details li"))e.style.display="flex"});