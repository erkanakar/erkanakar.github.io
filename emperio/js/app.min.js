...
var swiper=new Swiper(".project-slider",{slidesPerView:1,spaceBetween:10,pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{640:{slidesPerView:2,spaceBetween:15},1024:{slidesPerView:"auto",spaceBetween:15},1440:{slidesPerView:"auto",spaceBetween:19,centeredSlides:!0}}}),newsSlider=(swiper.params.containerModifierClass="swiper-container-custom-cursor ",swiper.params.mousewheel.sensitivity=1,new Swiper(".home-page-news-slider",{slidesPerView:1,spaceBetween:12,breakpoints:{640:{slidesPerView:2,spaceBetween:12},1024:{slidesPerView:3,spaceBetween:12},1440:{slidesPerView:3,spaceBetween:12}}}));
const menu=document.querySelector(".menu"),menuModal=document.querySelector(".menu-modal"),menuModalClose=document.querySelector(".close");var x,i,j,l,ll,selElmnt,a,b,c;for(menu.addEventListener("click",()=>{menuModal.classList.toggle("active"),$(".has-child").each(function(e,t){$(this).addClass("cssanimation sequence fadeInBottom")})}),menuModalClose.addEventListener("click",()=>{menuModal.classList.toggle("active"),$(".has-child").each(function(e,t){$(this).removeClass("cssanimation sequence fadeInBottom")})}),l=(x=document.getElementsByClassName("custom-select")).length,i=0;i<l;i++){for(ll=(selElmnt=x[i].getElementsByTagName("select")[0]).length,(a=document.createElement("DIV")).setAttribute("class","select-selected"),a.innerHTML=selElmnt.options[selElmnt.selectedIndex].innerHTML,x[i].appendChild(a),(b=document.createElement("DIV")).setAttribute("class","select-items select-hide"),j=1;j<ll;j++)(c=document.createElement("DIV")).innerHTML=selElmnt.options[j].innerHTML,c.addEventListener("click",function(e){for(var t,s,n,o=this.parentNode.parentNode.getElementsByTagName("select")[0],l=o.length,a=this.parentNode.previousSibling,i=0;i<l;i++)if(o.options[i].innerHTML==this.innerHTML){for(o.selectedIndex=i,a.innerHTML=this.innerHTML,n=(t=this.parentNode.getElementsByClassName("same-as-selected")).length,s=0;s<n;s++)t[s].removeAttribute("class");this.setAttribute("class","same-as-selected");break}a.click()}),b.appendChild(c);x[i].appendChild(b),a.addEventListener("click",function(e){e.stopPropagation(),closeAllSelect(this),this.nextSibling.classList.toggle("select-hide"),this.classList.toggle("select-arrow-active")})}function closeAllSelect(e){for(var t=[],s=document.getElementsByClassName("select-items"),n=document.getElementsByClassName("select-selected"),o=s.length,l=n.length,a=0;a<l;a++)e==n[a]?t.push(a):n[a].classList.remove("select-arrow-active");for(a=0;a<o;a++)t.indexOf(a)&&s[a].classList.add("select-hide")}document.addEventListener("click",closeAllSelect),window.onload=function(){document.getElementById("hero-image").style.transform="scale(1)"},window.onscroll=function(){var e=document.getElementById("hero-image"),t=window.scrollY;e.style.transform="scale("+(1+t/1e3)+")"};const aboutUs=document.querySelector(".home-page-about-us"),testimonial=document.querySelector(".testimonial"),aboutUsMore=document.querySelector(".home-page-about-us-more"),teamSection=document.querySelector(".home-page-team-section");function isInViewport(e){e=e.getBoundingClientRect();return 0<=e.top&&0<=e.left}window.addEventListener("scroll",()=>{isInViewport(aboutUs)&&aboutUs.classList.add("home-page-about-us-animate"),isInViewport(testimonial)&&testimonial.classList.add("testimonial-animate"),isInViewport(teamSection)&&teamSection.classList.add("team-section-animate")});const images=document.querySelectorAll(".parallax-img"),aboutMore=document.getElementById("about-more");for(const H of images)H.style.transform="translateY(50px)";window.addEventListener("scroll",function(){const e=aboutMore.offsetTop;if(-500<window.scrollY-e)for(const t of images){const e=(window.scrollY-aboutMore.offsetTop)/7;e<100&&0<e&&(t.style.transform=`translateY(${e}px)`)}});