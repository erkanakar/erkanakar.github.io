...
function controlFromInput(o,e,r,t){var[n,l]=getParsed(e,r);fillSlider(e,r,"#DFDEDE","#00A887",t),l<n?(o.value=l,e.value=l):o.value=n}function controlToInput(o,e,r,t){var[n,l]=getParsed(e,r);fillSlider(e,r,"#DFDEDE","#00A887",t),setToggleAccessible(r),n<=l?(o.value=l,r.value=l):r.value=n}function controlFromSlider(o,e,r){var[t,n]=getParsed(o,e);fillSlider(o,e,"#DFDEDE","#00A887",e),n<t?(o.value=n,r.value=n):r.value=t}function controlToSlider(o,e,r){var[t,n]=getParsed(o,e);fillSlider(o,e,"#DFDEDE","#00A887",e),setToggleAccessible(e),t<=n?(e.value=n,r.value=n):(r.value=t,e.value=t)}function getParsed(o,e){return[parseInt(o.value,10),parseInt(e.value,10)]}function fillSlider(o,e,r,t,n){var l=e.max-e.min,o=o.value-e.min,e=e.value-e.min;n.style.background=`linear-gradient(
      ...
      ${t} ${e/l*100}%, 
      ${r} ${e/l*100}%, 
      ${r} 100%)`}function setToggleAccessible(o){var e=document.querySelector("#toSlider");Number(o.value)<=0?e.style.zIndex=2:e.style.zIndex=0}const fromSlider=document.querySelector("#fromSlider"),toSlider=document.querySelector("#toSlider"),fromInput=document.querySelector("#fromInput"),toInput=document.querySelector("#toInput"),fromSliderZimmer=(fillSlider(fromSlider,toSlider,"#DFDEDE","#00A887",toSlider),setToggleAccessible(toSlider),fromSlider.oninput=()=>controlFromSlider(fromSlider,toSlider,fromInput),toSlider.oninput=()=>controlToSlider(fromSlider,toSlider,toInput),fromInput.oninput=()=>controlFromInput(fromSlider,fromInput,toInput,toSlider),toInput.oninput=()=>controlToInput(toSlider,fromInput,toInput,toSlider),document.querySelector("#fromSliderZimmer")),toSliderZimmer=document.querySelector("#toSliderZimmer"),fromInputZimmer=document.querySelector("#fromInputZimmer"),toInputZimmer=document.querySelector("#toInputZimmer"),fromSliderWohn=(fillSlider(fromSliderZimmer,toSliderZimmer,"#DFDEDE","#00A887",toSliderZimmer),setToggleAccessible(toSliderZimmer),fromSliderZimmer.oninput=()=>controlFromSlider(fromSliderZimmer,toSliderZimmer,fromInputZimmer),toSliderZimmer.oninput=()=>controlToSlider(fromSliderZimmer,toSliderZimmer,toInputZimmer),fromInputZimmer.oninput=()=>controlFromInput(fromSliderZimmer,fromInputZimmer,toInputZimmer,toSliderZimmer),toInputZimmer.oninput=()=>controlToInput(toSliderZimmer,fromInputZimmer,toInputZimmer,toSliderZimmer),document.querySelector("#fromSliderWohn")),toSliderWohn=document.querySelector("#toSliderWohn"),fromInputWohn=document.querySelector("#fromInputWohn"),toInputWohn=document.querySelector("#toInputWohn");fillSlider(fromSliderWohn,toSliderWohn,"#DFDEDE","#00A887",toSliderWohn),setToggleAccessible(toSliderWohn),fromSliderWohn.oninput=()=>controlFromSlider(fromSliderWohn,toSliderWohn,fromInputWohn),toSliderWohn.oninput=()=>controlToSlider(fromSliderWohn,toSliderWohn,toInputWohn),fromInputWohn.oninput=()=>controlFromInput(fromSliderWohn,fromInputWohn,toInputWohn,toSliderWohn),toInputWohn.oninput=()=>controlToInput(toSliderWohn,fromInputWohn,toInputWohn,toSliderWohn);