...
const text_reveal={_init:function(t){$(".text-reveal").each(function(){var t=text_reveal;$(this).hasClass("set")||($(this).hasClass("button")&&$(this).find("strong").length?t.prepare.buttons($(this),t,""):$(this).parents("#menu").length?t.prepare.menu($(this),t,""):t.prepare.headings($(this),t,""))})},get:{lines:function(t){return $.trim(t).split("\n")},words:function(t){return $.trim(t).split(" ")},wrap:function(t){return"<span><sub>"+t+"</sub></span>"}},set:function(t,e,n,a=!1){t.addClass("set"),e.html(n).find("span:last sub").html($.trim(e.find("span:last sub").text().replace("™","<sup>™</sup>"))),e.find("sup").each(function(){$(this).parents("sub").addClass("sup")}),a&&t.find("span").each(function(t){$(this).get(0).style.setProperty("--index",t)})},prepare:{buttons:function(t,n,a){$container=t.find("strong"),$.each(n.get.lines($container.text()),function(t,e){a+=(t?"\n":"")+n.get.wrap(e)}),n.set(t,$container,a,!0)},headings:function(t,s,i){t.addClass("headline"),$container=t,$.each(s.get.lines($container.text()),function(n,a){$.each(s.get.words(a),function(t,e){i+=(n&&!t?"\n":"")+s.get.wrap(e+(t<$.trim(a).split(" ").length-1?" ":""))})}),s.set(t,$container,i,!0)},menu:function(t,s,i){$container=t,$.each(s.get.lines($container.text()),function(n,a){$.each(s.get.words(a),function(t,e){i+=(n&&!t?"\n":"")+s.get.wrap(e+(t<$.trim(a).split(" ").length-1?" ":""))})}),s.set(t,$container,i,!1)}}};$(document).ready(function(){$(".sub-main").find("h1, h2, h3, h4, h5, h6").addClass("h1 pre diagonal text-reveal red reveal"),$(".sub-main").find("p").addClass("h1 pre diagonal text-reveal red reveal"),$("section .container").attr("data-aos","fade-up"),text_reveal._init(),AOS.init({disable:!1,startEvent:"DOMContentLoaded",initClassName:"aos-init",animatedClassName:"aos-animate",useClassNames:!1,disableMutationObserver:!1,debounceDelay:50,throttleDelay:99,offset:120,delay:0,duration:400,easing:"ease",once:!0,mirror:!1,anchorPlacement:"top-bottom"})});
var menuElements=document.querySelectorAll(".menu-modal-menu > li"),menuImgContainer=document.querySelector(".menu-modal-img-first"),menuImgContainerSecond=document.querySelector(".menu-modal-img-second");function calculatePercent(e,t){return e/t*100}function getOffset(e){e=e.getBoundingClientRect();return{left:e.left+window.scrollX,top:e.top+window.scrollY}}var widowWith=window.innerHeight,translateYvalue=-50,translateYvalueSecond=-50;menuElements.forEach(function(e,o){e.addEventListener("mouseover",function(){var e=document.querySelector(".menu-modal-img-first li:nth-child("+(o+3)+")"),t=(document.querySelectorAll(".menu-modal-img-first li").forEach(function(e){e.classList.remove("active-menu-img")}),e.classList.toggle("active-menu-img"),getOffset(e).top),n=window.scrollY||window.pageYOffset,l=calculatePercent(t-n,menuImgContainer.offsetHeight),e=calculatePercent(e.offsetHeight,menuImgContainer.offsetHeight);translateYvalue-=l-e,translateYvalueSecond+=l-e,menuImgContainer.style.transform="translateY("+translateYvalue+"%)",menuImgContainerSecond.style.transform="translateY("+translateYvalueSecond+"%)",console.log("scrollY: ",n),console.log("percent: ",l),console.log("liOffset: ",t)})});const listItems=document.querySelectorAll(".menu-modal-menu > li"),listElement=(listItems.forEach(function(e){e.addEventListener("mouseout",function(){document.querySelectorAll(".menu-modal-img-first li").forEach(function(e){e.classList.remove("active-menu-img")})})}),document.querySelector(".menu-modal-img-first li")),imgElement=document.querySelector(".menu-modal-img-first img");var $liElements=$(".menu-modal-img-first li:nth-last-child(-n+2)").clone(),liElement=($(".menu-modal-img").prepend($liElements),document.querySelectorAll(".menu-modal-img-first li")),imgLoad=!1;$(".has-child").click(function(){$(this).find("ul").slideToggle(),$(".has-child ul").not($(this).find("ul")).slideUp()});
var uberUnsSlider,swiper=new Swiper(".project-slider",{slidesPerView:1,spaceBetween:10,mousewheel:!0,pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{640:{slidesPerView:2,spaceBetween:15},1024:{slidesPerView:"auto",spaceBetween:15,centeredSlides:!0},1440:{slidesPerView:"auto",spaceBetween:19,centeredSlides:!0}}});if(document.querySelector(".project-slider")){const a=document.querySelector(".project-slider");window.addEventListener("scroll",function(){var e=a.getBoundingClientRect(),i=e.top;e.bottom,window.innerHeight;i<150&&0<i?(window.addEventListener("wheel",function(e){3<e.deltaX||e.deltaX<-3?(console.log("%c"+e.deltaX,"background-color: red; color: white"),console.log(e.deltaX),swiper.mousewheel.enable()):(swiper.mousewheel.disable(),console.log("%c"+e.deltaX,"background-color: green; color: white"))}),swiper.on("reachEnd",function(){swiper.mousewheel.disable()})):swiper.mousewheel.disable()}),swiper.params.containerModifierClass="swiper-container-custom-cursor ",swiper.params.mousewheel.sensitivity=1}var init=!1;function swiperMode(){var e=window.matchMedia("(min-width: 0px) and (max-width: 768px)"),i=window.matchMedia("(min-width: 768px) and (max-width: 1024px)"),r=window.matchMedia("(min-width: 1024px) and (max-width: 1440px)"),n=window.matchMedia("(min-width: 1440px) and (max-width: 1670px)");window.matchMedia("(min-width: 1670px)");i.matches||e.matches||r.matches||n.matches?init||(init=!0,uberUnsSlider=new Swiper(".uber-uns-slider",{slidesPerView:1,spaceBetween:10,pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{640:{slidesPerView:2,spaceBetween:15},1024:{slidesPerView:"auto",spaceBetween:15},1440:{slidesPerView:"auto",spaceBetween:85}}})):(init=!1,uberUnsSlider.destroy())}window.addEventListener("load",function(){swiperMode()}),window.addEventListener("resize",function(){swiperMode()});var newsSlider=new Swiper(".home-page-news-slider",{slidesPerView:1,spaceBetween:12,pagination:{el:".news-pagination",clickable:!0},breakpoints:{640:{slidesPerView:2,spaceBetween:12},1024:{slidesPerView:3,spaceBetween:12},1440:{slidesPerView:3,spaceBetween:12}}}),kaufenDetail=new Swiper(".kaufen-slider",{slidesPerView:1,spaceBetween:0,pagination:{el:".swiper-pagination",clickable:!0},navigation:{prevEl:".kaufen-slider-prev",nextEl:".kaufen-slider-next"}}),karriereSlider=new Swiper(".karriere-slider",{slidesPerView:1,spaceBetween:10,mousewheel:!0,pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{640:{slidesPerView:1,spaceBetween:12},1024:{slidesPerView:1,spaceBetween:12},1440:{slidesPerView:1,spaceBetween:12}}}),ratgeberSlider=(document.querySelector(".karriere-slider")&&(window.addEventListener("wheel",function(e){e.deltaY<0&&karriereSlider.mousewheel.enable()}),karriereSlider.on("reachEnd",function(){karriereSlider.mousewheel.disable()}),karriereSlider.params.containerModifierClass="swiper-container-custom-cursor ",karriereSlider.params.mousewheel.sensitivity=1),new Swiper(".ratgeber-slider",{slidesPerView:1,spaceBetween:10,mousewheel:!0,pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{640:{slidesPerView:1,spaceBetween:12},1024:{slidesPerView:"auto",spaceBetween:120,centeredSlides:!0},1440:{slidesPerView:"auto",spaceBetween:170,centeredSlides:!0}}})),referencesSlider=(document.querySelector(".ratgeber-slider")&&(window.addEventListener("wheel",function(e){e.deltaY<0&&ratgeberSlider.mousewheel.enable()}),ratgeberSlider.on("reachEnd",function(){ratgeberSlider.mousewheel.disable()}),ratgeberSlider.params.containerModifierClass="swiper-container-custom-cursor ",ratgeberSlider.params.mousewheel.sensitivity=1),new Swiper(".references-slider",{slidesPerView:1,spaceBetween:10,navigation:{prevEl:".references-slider-left",nextEl:".references-slider-right"}}));
const menu=document.querySelector(".menu"),menuModal=document.querySelector(".menu-modal"),menuModalClose=document.querySelector(".close");var x,i,j,l,ll,selElmnt,a,b,c;for(menu.addEventListener("click",()=>{menuModal.classList.toggle("active"),$("li").each(function(e,t){$(this).addClass("cssanimation sequence fadeInBottom")})}),menuModalClose.addEventListener("click",()=>{menuModal.classList.toggle("active"),$(".has-child").each(function(e,t){$(this).removeClass("cssanimation sequence fadeInBottom")})}),l=(x=document.getElementsByClassName("custom-select")).length,i=0;i<l;i++){for(ll=(selElmnt=x[i].getElementsByTagName("select")[0]).length,(a=document.createElement("DIV")).setAttribute("class","select-selected"),a.innerHTML=selElmnt.options[selElmnt.selectedIndex].innerHTML,x[i].appendChild(a),(b=document.createElement("DIV")).setAttribute("class","select-items select-hide"),j=1;j<ll;j++)(c=document.createElement("DIV")).innerHTML=selElmnt.options[j].innerHTML,c.addEventListener("click",function(e){for(var t,o,n,s=this.parentNode.parentNode.getElementsByTagName("select")[0],a=s.length,l=this.parentNode.previousSibling,i=0;i<a;i++)if(s.options[i].innerHTML==this.innerHTML){for(s.selectedIndex=i,l.innerHTML=this.innerHTML,n=(t=this.parentNode.getElementsByClassName("same-as-selected")).length,o=0;o<n;o++)t[o].removeAttribute("class");this.setAttribute("class","same-as-selected");break}l.click()}),b.appendChild(c);x[i].appendChild(b),a.addEventListener("click",function(e){e.stopPropagation(),closeAllSelect(this),this.nextSibling.classList.toggle("select-hide"),this.classList.toggle("select-arrow-active")})}function closeAllSelect(e){for(var t=[],o=document.getElementsByClassName("select-items"),n=document.getElementsByClassName("select-selected"),s=o.length,a=n.length,l=0;l<a;l++)e==n[l]?t.push(l):n[l].classList.remove("select-arrow-active");for(l=0;l<s;l++)t.indexOf(l)&&o[l].classList.add("select-hide")}document.addEventListener("click",closeAllSelect),window.onload=function(){var e=document.getElementById("hero-image");e&&(e.style.transform="scale(1)")},window.onscroll=function(){var e,t=document.getElementById("hero-image");t&&(e=window.scrollY,t.style.transform=0!=e?"scale(2.27)":"scale(1)",50<=e?(document.querySelector(".home-page-main-img-box a").style.opacity=0,document.querySelector("#breadcrumb").style.opacity=1):0==e&&(document.querySelector(".home-page-main-img-box a").style.opacity=1,document.querySelector("#breadcrumb").style.opacity=0),t=e-1e3,textSlide.style.transform="translate3d("+t+"px, 0, 0)")};const aboutUs=document.querySelector(".home-page-about-us"),testimonial=document.querySelector(".testimonial"),aboutUsMore=document.querySelector(".home-page-about-us-more"),teamSection=document.querySelector(".home-page-team-section"),textSlide=document.querySelector(".text-slide .text-slide-wrapper"),newSection=document.querySelector(".home-page-news"),kaufeSection=document.querySelector(".kaufen-detail-page-first"),kaufeImageSection=document.querySelectorAll(".kaufen-detail-page-image-section .col-12 div");var didScroll,breadcrumbDiv=document.querySelector("#breadcrumb"),sections=document.querySelectorAll("section");function getScreenWidth(){return window.innerWidth}window.addEventListener("scroll",function(){sections.forEach(function(e){var t;"/"!==window.location.pathname&&"/index.html"!==window.location.pathname&&"/index.php"!==window.location.pathname?(t=document.querySelector("h1"),breadcrumbDiv.innerHTML="<p>"+t.textContent+"</p>"):isInViewport(e,60)&&e.querySelector("h2")&&(t=e.querySelector("h2").textContent,breadcrumbDiv.innerHTML="<p>"+t+"</p>")})}),window.addEventListener("scroll",()=>{aboutUs&&isInViewport(aboutUs,75)&&aboutUs.classList.add("home-page-about-us-animate"),testimonial&&isInViewport(testimonial,60)&&testimonial.classList.add("testimonial-animate"),teamSection&&isInViewport(teamSection,60)&&teamSection.classList.add("team-section-animate"),newSection&&isInViewport(newSection,60)&&newSection.classList.add("home-page-news-animate"),aboutUsMore&&isInViewport(aboutUsMore,50)&&aboutUsMore.classList.add("home-page-about-us-more-animate"),kaufeSection&&(767<getScreenWidth()?isInViewport(kaufeSection,70)&&kaufeSection.classList.add("home-page-news-animate"):isInViewport(kaufeSection,20)&&kaufeSection.classList.add("home-page-news-animate")),kaufeImageSection&&kaufeImageSection.forEach(e=>{isInViewport(e,50)&&e.classList.add("home-page-news-animate")})});const isInViewport=function(e,t){var e=e.getBoundingClientRect(),o=window.innerHeight||document.documentElement.clientHeight;return!(Math.floor(100-(0<=e.top?0:e.top)/-e.height*100)<t||Math.floor(100-(e.bottom-o)/e.height*100)<t)};function scrollDown(){$("html, body").animate({scrollTop:$(window).height()},"slow")}$(".question").click(function(){$(this).next(".answer").slideToggle(),$(this).toggleClass("question-opened")}),$(".scroll-down").click(scrollDown);const showMoreButton=document.querySelector(".show-more");showMoreButton&&showMoreButton.addEventListener("click",function(){var t=document.querySelectorAll(".home-details li");if(this.className.includes("show-more-opened")){this.classList.remove("show-more-opened"),console.log("test");let e=0;for(const o of t)e<12&&(o.style.display="none",e++)}else{this.classList.add("show-more-opened");for(const e of t)e.style.display="flex"}});var lastScrollTop=0,delta=5,navbarHeight=$("header").outerHeight();function hasScrolled(){var e=$(this).scrollTop();Math.abs(lastScrollTop-e)<=delta||(lastScrollTop<e&&navbarHeight<e?$("header").removeClass("nav-down").addClass("nav-up"):e+$(window).height()<$(document).height()&&(0===window.scrollY?(header.classList.remove("nav-up"),header.classList.remove("nav-down")):$("header").removeClass("nav-up").addClass("nav-down")),lastScrollTop=e)}$(window).scroll(function(e){didScroll=!0}),setInterval(function(){didScroll&&(hasScrolled(),didScroll=!1)},250);const header=document.querySelector("header");function addCommas(e){for(var e=(e+="").split("’"),t=e[0],e=1<e.length?"."+e[1]:"",o=/(\d+)(\d{3})/;o.test(t);)t=t.replace(o,"$1’$2");return t+e}window.addEventListener("scroll",function(){0===window.scrollY&&(header.classList.remove("nav-up"),header.classList.remove("nav-down"),document.querySelector("#breadcrumb").innerHTML="")});const currentPage=window.location.pathname.substr(1),menuLinks=document.querySelectorAll(".desktop-menu ul li a");menuLinks.forEach(e=>{e.getAttribute("href")===currentPage&&e.classList.add("active")}),$(".filter-button").click(function(){$(this).toggleClass("filter-button-active"),$(".filter-section-inner").slideToggle()}),$(document).ready(function(){document.querySelectorAll('a[href^="mailto:"]').forEach(function(e){var t=encodeURIComponent(document.title);e.href+="?subject="+t})});
function controlFromInput(e,o,r,t){var[l,n]=getParsed(o,r);fillSlider(o,r,"#DFDEDE","#00A887",t),n<l?(e.value=n,o.value=n):e.value=l}function controlToInput(e,o,r,t){var[l,n]=getParsed(o,r);fillSlider(o,r,"#DFDEDE","#00A887",t),setToggleAccessible(r),l<=n?(e.value=n,r.value=n):r.value=l}function controlFromSlider(e,o,r){var[t,l]=getParsed(e,o);fillSlider(e,o,"#DFDEDE","#00A887",o),l<t?(e.value=l,r.value=l):r.value=t}function controlToSlider(e,o,r){var[t,l]=getParsed(e,o);fillSlider(e,o,"#DFDEDE","#00A887",o),setToggleAccessible(o),t<=l?(o.value=l,r.value=l):(r.value=t,o.value=t)}function getParsed(e,o){return[parseInt(e.value,10),parseInt(o.value,10)]}function fillSlider(e,o,r,t,l){var n=o.max-o.min,e=e.value-o.min,o=o.value-o.min;l.style.background=`linear-gradient(
      to right,
      ${r} 0%,
      ${r} ${e/n*100}%,
      ${t} ${e/n*100}%,
      ${t} ${o/n*100}%, 
      ${r} ${o/n*100}%, 
      ${r} 100%)`}function setToggleAccessible(e){var o=document.querySelector("#toSlider");Number(e.value)<=0?o.style.zIndex=2:o.style.zIndex=0}const fromSlider=document.querySelector("#fromSlider"),toSlider=document.querySelector("#toSlider"),fromInput=document.querySelector("#fromInput"),toInput=document.querySelector("#toInput");if(fromSlider&&toSlider){fillSlider(fromSlider,toSlider,"#DFDEDE","#00A887",toSlider),setToggleAccessible(toSlider),fromSlider.oninput=()=>controlFromSlider(fromSlider,toSlider,fromInput),toSlider.oninput=()=>controlToSlider(fromSlider,toSlider,toInput),fromInput.oninput=()=>controlFromInput(fromSlider,fromInput,toInput,toSlider),toInput.oninput=()=>controlToInput(toSlider,fromInput,toInput,toSlider);const K=document.querySelector("#fromSliderZimmer"),L=document.querySelector("#toSliderZimmer"),M=document.querySelector("#fromInputZimmer"),N=document.querySelector("#toInputZimmer"),O=(fillSlider(K,L,"#DFDEDE","#00A887",L),setToggleAccessible(L),K.oninput=()=>controlFromSlider(K,L,M),L.oninput=()=>controlToSlider(K,L,N),M.oninput=()=>controlFromInput(K,M,N,L),N.oninput=()=>controlToInput(L,M,N,L),document.querySelector("#fromSliderWohn")),P=document.querySelector("#toSliderWohn"),Q=document.querySelector("#fromInputWohn"),R=document.querySelector("#toInputWohn");fillSlider(O,P,"#DFDEDE","#00A887",P),setToggleAccessible(P),O.oninput=()=>controlFromSlider(O,P,Q),P.oninput=()=>controlToSlider(O,P,R),Q.oninput=()=>controlFromInput(O,Q,R,P),R.oninput=()=>controlToInput(P,Q,R,P)}
var image=document.getElementsByClassName("parallax-img-wrapper"),kaufenImage=document.getElementsByClassName("kaufen-detail-image"),servicesBox=document.getElementsByClassName("sales-services-box");new simpleParallax(image,{overflow:!0}),new simpleParallax(kaufenImage,{overflow:!0}),new simpleParallax(servicesBox,{overflow:!0}),window.onload=function(){document.getElementById("loading-screen").style.display="none"};
const footer=document.querySelector("footer"),footerHeight=footer.offsetHeight,distanceFromBottom=window.innerHeight-footerHeight-20;window.addEventListener("scroll",function(){document.documentElement.scrollHeight-(window.innerHeight+window.pageYOffset)<=distanceFromBottom?footer.classList.add("sticky"):footer.classList.remove("sticky")});