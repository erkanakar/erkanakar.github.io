...
var swiper=new Swiper(".project-slider",{slidesPerView:1,spaceBetween:10,mousewheel:!0,pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{640:{slidesPerView:2,spaceBetween:15},1024:{slidesPerView:"auto",spaceBetween:15},1440:{slidesPerView:"auto",spaceBetween:19,centeredSlides:!0}}}),newsSlider=(swiper.on("reachEnd",function(){swiper.mousewheel.disable()}),swiper.params.containerModifierClass="swiper-container-custom-cursor ",swiper.params.mousewheel.sensitivity=1,new Swiper(".home-page-news-slider",{slidesPerView:1,spaceBetween:12,breakpoints:{640:{slidesPerView:2,spaceBetween:12},1024:{slidesPerView:3,spaceBetween:12},1440:{slidesPerView:3,spaceBetween:12}}}));
const menu=document.querySelector(".menu"),menuModal=document.querySelector(".menu-modal"),menuModalClose=document.querySelector(".close");var x,i,j,l,ll,selElmnt,a,b,c;for(menu.addEventListener("click",()=>{menuModal.classList.toggle("active"),$(".has-child").each(function(e,t){$(this).addClass("cssanimation sequence fadeInBottom")})}),menuModalClose.addEventListener("click",()=>{menuModal.classList.toggle("active"),$(".has-child").each(function(e,t){$(this).removeClass("cssanimation sequence fadeInBottom")})}),l=(x=document.getElementsByClassName("custom-select")).length,i=0;i<l;i++){for(ll=(selElmnt=x[i].getElementsByTagName("select")[0]).length,(a=document.createElement("DIV")).setAttribute("class","select-selected"),a.innerHTML=selElmnt.options[selElmnt.selectedIndex].innerHTML,x[i].appendChild(a),(b=document.createElement("DIV")).setAttribute("class","select-items select-hide"),j=1;j<ll;j++)(c=document.createElement("DIV")).innerHTML=selElmnt.options[j].innerHTML,c.addEventListener("click",function(e){for(var t,o,n,s=this.parentNode.parentNode.getElementsByTagName("select")[0],l=s.length,i=this.parentNode.previousSibling,a=0;a<l;a++)if(s.options[a].innerHTML==this.innerHTML){for(s.selectedIndex=a,i.innerHTML=this.innerHTML,n=(t=this.parentNode.getElementsByClassName("same-as-selected")).length,o=0;o<n;o++)t[o].removeAttribute("class");this.setAttribute("class","same-as-selected");break}i.click()}),b.appendChild(c);x[i].appendChild(b),a.addEventListener("click",function(e){e.stopPropagation(),closeAllSelect(this),this.nextSibling.classList.toggle("select-hide"),this.classList.toggle("select-arrow-active")})}function closeAllSelect(e){for(var t=[],o=document.getElementsByClassName("select-items"),n=document.getElementsByClassName("select-selected"),s=o.length,l=n.length,i=0;i<l;i++)e==n[i]?t.push(i):n[i].classList.remove("select-arrow-active");for(i=0;i<s;i++)t.indexOf(i)&&o[i].classList.add("select-hide")}document.addEventListener("click",closeAllSelect),window.onload=function(){document.getElementById("hero-image").style.transform="scale(1)"},window.onscroll=function(){var e=document.getElementById("hero-image"),t=window.scrollY,e=(e.style.transform=0!=t?"scale(2.27)":"scale(1)",t-1e3);textSlide.style.transform="translate3d("+e+"px, 0, 0)"};const aboutUs=document.querySelector(".home-page-about-us"),testimonial=document.querySelector(".testimonial"),aboutUsMore=document.querySelector(".home-page-about-us-more"),teamSection=document.querySelector(".home-page-team-section"),textSlide=document.querySelector(".text-slide .text-slide-wrapper"),newSection=document.querySelector(".home-page-news"),isInViewport=(window.addEventListener("scroll",()=>{isInViewport(aboutUs,10)&&(aboutUs.classList.add("home-page-about-us-animate"),console.log("About Us",isInViewport(aboutUs,5))),isInViewport(testimonial,10)&&(testimonial.classList.add("testimonial-animate"),console.log("testimonial",isInViewport(testimonial,5))),isInViewport(teamSection,10)&&(teamSection.classList.add("team-section-animate"),console.log("teamSection",isInViewport(teamSection,5))),isInViewport(newSection,10)&&(newSection.classList.add("home-page-news-animate"),console.log("newSection",isInViewport(newSection,5))),isInViewport(aboutUsMore,10)&&(aboutUsMore.classList.add("home-page-about-us-more-animate"),console.log("About Us More",isInViewport(aboutUsMore,5)))}),function(e,t){var e=e.getBoundingClientRect(),o=window.innerHeight||document.documentElement.clientHeight;return!(Math.floor(100-(0<=e.top?0:e.top)/-e.height*100)<t||Math.floor(100-(e.bottom-o)/e.height*100)<t)}),images=document.querySelectorAll(".parallax-img"),aboutMore=document.getElementById("about-more");for(const K of images)K.style.transform="translateY(50px)";window.addEventListener("scroll",function(){const e=aboutMore.offsetTop;if(-500<window.scrollY-e)for(const t of images){const e=(window.scrollY-aboutMore.offsetTop)/7;e<100&&0<e&&(t.style.transform=`translateY(${e}px)`)}});